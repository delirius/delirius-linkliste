...
$GLOBALS['TL_LANG']['tl_module']['delirius_linkliste_standardfavicon'] = array('Standard Bild','');
...
$GLOBALS['TL_LANG']['tl_module']['fesort_option']['text'] = 'Reihenfolge alphabetisch nach Link-Text';
$GLOBALS['TL_LANG']['tl_module']['fesort_option']['title'] = 'Reihenfolge alphabetisch nach Titel';
